...
# Verify that the shape is as expected (num_samples, 2500)
...
# Normalize the training data (scale pixel values to [0, 1])


# Train the classifier with the normalized face data
...
while True:
    ...
    for (x, y, w, h) in detected_faces:
        ...
        # Resize the cropped image to 50x50 pixels (match the training data size)
        resized_img = cv2.resize(crop_img, (50, 50))
        
        # Flatten the image to match the input feature size of 2500 (50*50)
